...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header"><?php echo isset($venta) ? 'Actualizar' : 'Nueva' ?> Asignación de Ruta | <a href="<?php url('venta')?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Ver listado</a>
					</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
						...
						<div class="panel-body">
							<form action="<?php url('venta/agregar')?>" method="POST" role="form">
								...
								<div class="form-group">
									<label for="usuario">Nombre del Conductor</label>
								...
								<?php if (isset($venta)) {?>
									<div class="form-group">
										<label for="precio">Vehiculo</label>
